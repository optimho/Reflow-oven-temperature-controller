 ...
 */
 ...
 double Ctemp[6]={45,150,185,225,0,0}; //Temperatures to become the setpoint in degrees C                 
 double Cdwell[6]={80000,90000,90000,30000,50000,50000}; //this is the delay at a specified temperature, in Milli Seconds
 ...
 void setup()
 {
   ...
   aRec.temp=Ctemp[gIndex];         // Temperature Setpoints
